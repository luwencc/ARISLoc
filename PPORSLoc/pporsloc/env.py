...
from .config import (ACTION_STOP_ID, MOVE_TO_DRL_RPS, NUM_DRL_ACTIONS, NUM_PATH_SEGMENTS, NUM_PHASES, OBS_GRID_ZSCORE, OBS_META_DIM, OBS_RSS_DIM, PER_STEP_LOCALIZE, PRECOMPUTE_PATH1_LOCS, SUB_EPISODE_ALIGNED_CSV, PPOConfig)
...
class PathPhaseMultiRPEnv(gym.Env):
    ...
    def __init__(self, cfg: PPOConfig, traj_index: Dict[str, Set[str]], localizer_bundle: Tuple[Any, ...], catalog: TrajFolderCatalog, traj_cache: Optional[TrajCsvLRUCache]=None):
        ...
        self.all_rps = list(MOVE_TO_DRL_RPS)
