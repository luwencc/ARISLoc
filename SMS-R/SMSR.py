#!/usr/bin/env python3
"""SMS-R entry point and public API for the localization network."""
...
from smsr.config import Config
from smsr.data import (
    build_sparse_phase_path_grid,
    load_csv_rssi_column,
    parse_path_phase_segments,
)
from smsr.evaluate import (
    _build_rp_xy_lut_tensor,
    _eval_softmax_denom_scale,
...
from smsr.model import MixedModel
from smsr.normalize import z_score_apply_phase_grid, z_score_apply_vector
from smsr.train import train_model
from smsr.utils import _amp_autocast_ctx
...
if __name__ == "__main__":
    RETRAIN = True
    if RETRAIN:
        print("[mode] train SMS-R sparse grid")
